      ...
      child: Column(
        ...
        children: [
          ElevatedButton(
              ...
              style: ButtonStyle(
                minimumSize:
                    MaterialStateProperty.all<Size>(const Size(400.0, 50.0)),
                backgroundColor:
            ...
            child: StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasData) {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        Map<String, dynamic> jsonData =
                            json.decode(document['array_address'][index]);
                        return ListTile(
                  ...
                  return const Center(
                    child: Text("Ha ocurrido un error, intenta más tarde"),
                  );
                }
              },
            ),
